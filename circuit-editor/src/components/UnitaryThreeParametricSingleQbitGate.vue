  ...
  <div v-on:click="handleClick">
    ...
    <b-modal ref="initial-modal-dialog" size="sm"  centered hide-footer hide-header>
      ...
      <table style="table-layout:fixed;">
        ...
        <tr>
          <td></td>
          <td title="Gate parameter" width="100px" style="padding: 5px;">Theta:</td>
        ...
        <tr>
          <td></td>
          <td title="Gate parameter" width="100px" style="padding: 5px;">Phi:</td>
          <td width="100px" style="padding: 5px;"> 
        ...
        <tr>
          <td></td>
          <td title="Gate parameter" width="100px" style="padding: 5px;">Lambda:</td>
          <td width="100px" style="padding: 5px;"> 
