  ...
  <div v-on:click="handleClick">
    ...
    <b-modal ref="initial-modal-dialog" size="sm"  centered hide-footer hide-header>
      ...
      <table style="table-layout:fixed;">
        ...
        <tr>
          ...
          <td width="100px" style="padding: 5px;"> 
            <b-form-select v-model="controlstateNew" :options="options" style="width:90px;" id="controlstate-new-1"></b-form-select>
          </td>
          <td></td>
        </tr>
        <tr>
          ...
          <td width="100px" style="padding: 5px;"> 
            <b-form-input min="0" @keyup.enter.native="handleSave()" v-model="controlNew2" placeholder="control2" type="number" id="control-new-2" style="width:90px;"></b-form-input>
          </td>
          <td></td>
        </tr>
        <tr>
          ...
          <td width="100px" style="padding: 5px;"> 
            <b-form-select v-model="controlstateNew2" :options="options2" style="width:90px;" id="controlstate-new-2"></b-form-select>
          </td>
          <td></td>
        </tr>
        <tr>
    ...
    <b-modal ref="replicate-gate-modal-dialog" size="lg" width="100px" centered hide-footer hide-header>
      <table>
        ...
        <tr>
          <td colspan="3" width="300px" class="td-2nd-modal">
            Control-2 Qubit - 'q, s' based <br/>javascript expression:
          </td>
          <td colspan="3" width="400px" class="td-2nd-modal">
            <b-form-input min="0" v-model="control2Expression" placeholder="" type="text" id="ctrl-2-qbit" style="min-width:400px;"></b-form-input>
          </td>
          <td class="no-resize-cell"></td>
        </tr>
        <tr>
          <td colspan="3" width="300px" class="td-2nd-modal">
            Control-2 State - 'q, s' based <br/>javascript expression:
          </td>
          <td colspan="3" width="400px" class="td-2nd-modal">
            <b-form-input min="0" v-model="controlstate2Expression" placeholder="" type="text" id="ctrl-2-state" style="min-width:400px;"></b-form-input>
          </td>
          <td class="no-resize-cell"></td>
        </tr>
        <tr>
...
export default {
  ...
  data() {
    return {
      ...
      control2Expression: this.control2,
      controlstate2Expression: this.controlstate2,
      options: [
        { value: '1', text: '|1⟩' },
        { value: '0', text: '|0⟩' },
      ],
  ...
  methods: {
    ...
    handleReplicateGateModalSave: function(){
      let promise = this.duplicateGate({
        ...
        'control2Expression': this.control2Expression,
        'controlstate2Expression': this.controlstate2Expression,
      });
      promise.then(
        // eslint-disable-next-line no-unused-vars
        result => {}, 
