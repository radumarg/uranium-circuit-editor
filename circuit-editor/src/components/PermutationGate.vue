  ...
  <div :step="step" :qrow="qrow" v-on:click="handleClick" @dragenter.prevent @dragover.prevent @drop.prevent="handleDropEvent">
    ...
    <b-modal ref="initial-modal-dialog" size="sm" modal-class="help-sidebar" centered hide-footer hide-header>
      <table style="table-layout:fixed;">
        ...
        <tr>
          <td></td>
          <td width="70px" title="First qubit.">First Qubit:</td>
        ...
        <tr>
          <td></td>
          <td width="70px" title="Last qubit.">Last Qubit:</td>
          <td width="130px" style="padding: 5px;">
        ...
        <tr>
          <td></td>
          <td width="70px" title="Target expression is used to define the qubit permutation formula. It must be a Javascript 'j' based expression where 'j' is a zero based index of the target qubit where first target qubit has index 0 and the last target qubit has maximum index.">Targets Expr:</td>
          <td width="130px" style="padding: 5px;">
